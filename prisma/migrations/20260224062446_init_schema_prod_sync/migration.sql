...
-- CreateTable
CREATE TABLE IF NOT EXISTS "DistributorPlanPrice" (
    "id" TEXT NOT NULL,
    "distributorId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "DistributorCredit" (
    "id" TEXT NOT NULL,
    "distributorId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CreditCutoff" (
    "id" TEXT NOT NULL,
    "distributorId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Distributor_identification_key" ON "Distributor"("identification");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Distributor_email_key" ON "Distributor"("email");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "BillingInfo_distributorId_key" ON "BillingInfo"("distributorId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Plan_perfilNaturalEnext_key" ON "Plan"("perfilNaturalEnext");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Plan_perfilJuridicoEnext_key" ON "Plan"("perfilJuridicoEnext");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Plan_perfilNaturalUanataca_key" ON "Plan"("perfilNaturalUanataca");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Plan_perfilJuridicoUanataca_key" ON "Plan"("perfilJuridicoUanataca");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Plan_perfilNaturalTokenUanataca_key" ON "Plan"("perfilNaturalTokenUanataca");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Plan_perfilJuridicoTokenUanataca_key" ON "Plan"("perfilJuridicoTokenUanataca");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "DistributorPlanPrice_distributorId_idx" ON "DistributorPlanPrice"("distributorId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "DistributorPlanPrice_planId_idx" ON "DistributorPlanPrice"("planId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "DistributorPlanPrice_isActive_idx" ON "DistributorPlanPrice"("isActive");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "DistributorPlanPrice_distributorId_planId_key" ON "DistributorPlanPrice"("distributorId", "planId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "SignatureRequest_numero_tramite_key" ON "SignatureRequest"("numero_tramite");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "SignatureRequest_distributorId_createdAt_idx" ON "SignatureRequest"("distributorId", "createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "SignatureRequest_planId_idx" ON "SignatureRequest"("planId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Recharge_numberReceipt_key" ON "Recharge"("numberReceipt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "DistributorCredit_distributorId_isActive_idx" ON "DistributorCredit"("distributorId", "isActive");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "DistributorCredit_distributorId_isBlocked_idx" ON "DistributorCredit"("distributorId", "isBlocked");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreditCutoff_distributorId_cutoffDate_idx" ON "CreditCutoff"("distributorId", "cutoffDate");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreditCutoff_creditId_isPaid_idx" ON "CreditCutoff"("creditId", "isPaid");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreditCutoff_paymentDueDate_isPaid_idx" ON "CreditCutoff"("paymentDueDate", "isPaid");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "CreditCutoff_creditId_cutoffDate_key" ON "CreditCutoff"("creditId", "cutoffDate");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "AccountMovement_signatureId_idx" ON "AccountMovement"("signatureId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "TokenInfo_signatureRequestId_key" ON "TokenInfo"("signatureRequestId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "TokenInfo_signatureRequestId_idx" ON "TokenInfo"("signatureRequestId");
